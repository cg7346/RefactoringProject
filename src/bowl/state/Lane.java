...
public class Lane extends Thread implements IPinsetterObserver {
    ...
    void insertFinalScore(Bowler bowler){
        ...
        try {
            ...
            String dateString = "" + cal.get(Calendar.HOUR_OF_DAY) + ":" + cal.get(Calendar.MINUTE) + " " + cal.get(Calendar.MONTH) + "/" + cal.get(Calendar.DAY_OF_MONTH)+ "/" + (cal.get(Calendar.YEAR)/* + 1900*/); // TODO: (Gio) +1900 shouldn't be needed
